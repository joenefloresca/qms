	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-success">
				<div class="panel-heading">Agent Performance Net</div>
					...
					<div class="col-md-12 form-horizontal" style="padding-bottom: 5px">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button type="button" class="btn btn-primary" id="btnDateAgentPerNet">
									Submit
								</button>
							</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-success"> 
				<div class="panel-heading">Agent Performance Net</div>
				<div class="panel-body">
					<table id="AgentPerformanceNet" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
...
@endsection
@section('agentperformancenet')
<script type="text/javascript">
$("#btnDateAgentPerNet").click(function() {
	var sph = 0;
	var revperhour = 0;
	if($.fn.dataTable.isDataTable('#AgentPerformanceNet')) 
	{
    	table.destroy();
    	table = $('#AgentPerformanceNet').DataTable();
    	table.clear().draw();
    	var tt = new $.fn.dataTable.TableTools( table );
	    $( tt.fnContainer() ).insertBefore('div.dataTables_wrapper');
	    $.ajax({
		url: "api/crm/agentperformancenet", 
		type: 'GET',
